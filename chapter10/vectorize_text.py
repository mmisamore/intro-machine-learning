...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    for path in from_person:
        ...
        if temp_counter < 200:
            ...
            # print "Stemmed input: ", stemmed

            ### use str.replace() to remove any instances of the words
            ### ["sara", "shackleton", "chris", "germani"]

            # NB: We should probably just split the string and filter on words, but
            # I'm just following instructions here
            for w in ["sara", "shackleton", "chris", "germani"]:
                stemmed = stemmed.replace(w, '')
            # print "Stemmed input after string replacement:", stemmed
...
print "Feature name at 34597:", vectorizer.get_feature_names()[34597]
